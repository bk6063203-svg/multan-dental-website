...
export default function Gallery() {
  const galleryItems = [
    ...
    // Nai 5 images (Make sure ye file names public folder mein hon)
    { id: 5, src: "/before-after-1.png", alt: "Before After Result 1" },
    { id: 6, src: "/teeth-whitening-results.png", alt: "Teeth Whitening Results" },
    { id: 7, src: "/dental-scan-1.png", alt: "Dental Scan 1" },
    { id: 8, src: "/dental-scan-2.png", alt: "Dental Scan 2" },
    { id: 9, src: "/aligners-case.png", alt: "Aligners Case" },
  ];
  ...
  return (
    <section id="gallery" className="py-24 px-6 bg-white">
      <div className="container mx-auto max-w-7xl">
        ...
        {/* Grid adjusted to handle more images */}
